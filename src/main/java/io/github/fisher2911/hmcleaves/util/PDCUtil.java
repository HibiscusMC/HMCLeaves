...
public class PDCUtil {
    ...
    public static LeafData getLeafData(PersistentDataContainer container) {
        final Integer distance = container.get(DISTANCE_KEY, PersistentDataType.INTEGER);
        ...
        if (distance == null || persistence == null || material == null) return null;
        try {
            return new LeafData(Material.valueOf(material), distance, persistence == 1);
